...
$result = FetchData($query);
 ...
 $query2 = "select id,name,url,type,info from company_registration where id in (select company_id from student_company where student_id=$id and active=1) ";//and approved=1
...
?>
            <div class="container">
                <div class="row">
                    <?php if($n>0){?>
                        <div class="col-md-12">
                            <h1 class="page-header">Registered Companies</h1>
                        </div>
                ...
                <div class="row">
                    <?php if($n1>0){?>
                        <div class="col-md-12">
                            <h1 class="page-header">Available Companies</h1>
                        </div>
                        <table class="table table-bordered table-hover">
                            <tr>
                                <td>ID</td>
			...
			while($data = mysql_fetch_array($result)){
				...
				if($data[5]=="For All" || $data[5]==$course){
				...
				?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="companyinfo.php?id=<?php echo $data[0];?>">
                                            <?php echo $data[1]?>
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="student_companyregistration.php?student_id=<?php echo $id?>&company_id=<?php echo $data[0];?>&active=1">
            ...
            <footer>
                <div class="row">
                    <div class="col-lg-12">
                        <p>
                            <center>Copyright &copy; Placement Cell 2016</center>
                        </p>
                    </div>
                </div>
            </footer>
