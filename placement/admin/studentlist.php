...
<body>
    ...
    <?php 
    		$query = "select uid,college_id,name,course,branch,year,cgpa,approved from student_table";
          ...
          <table class="table table-bordered table-hover">
			...
			while($data = mysql_fetch_array($result)){
				...
				<tr>
                    ...
                    <td><a href="studentinfo.php?student_id=<?php echo $data[1];?>"><?php echo $data[2]?></a></td>
                    <td><?php echo $data[3]?></td>
                    <td><?php echo $data[4]?></td>
                    <td><?php echo $data[5]?></td>
                    <td><?php echo $data[6]?></td>
                    <td><?php if($data[7]==1){?><span class="label label-primary">Approved</span><?php } else {?><span class="label label-danger">Not Approved</span>
				<?php }?></td>
                    </tr>
				<?php
			}
